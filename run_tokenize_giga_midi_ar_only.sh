...
#SBATCH --mem=50GB
#SBATCH -t 10:00:00
#SBATCH -J tokenize_dataset_giga_midi_ar_only
...
PYTHONPATH=. python train/v2/dataset_tokenize.py --dataset_type giga_midi --settings_json_name "ar_only_local_midi_settings_6fcc94c173552d9e87d57ecec95a1d97.json"
